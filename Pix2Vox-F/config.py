...
# __C.DATASETS.PIX3D.TAXONOMY_FILE_PATH       = './dataset/Pix3D.json'
...
__C.CONST.INFO_BATCH                        = 50        # Print once for 50 batches
...
__C.DIR.RANDOM_BG_PATH                      = '/home/aistudio/Datasets/SUN2012/JPEGImages'
...
__C.TRAIN.ENCODER_LR_MILESTONES             = [90]
__C.TRAIN.DECODER_LR_MILESTONES             = [90]
__C.TRAIN.MERGER_LR_MILESTONES              = [90]
__C.TRAIN.BETAS                             = (.9, .999)
__C.TRAIN.MOMENTUM                          = .9
__C.TRAIN.GAMMA                             = .5
__C.TRAIN.SAVE_FREQ                         = 250            # weights will be overwritten every save_freq epoch
